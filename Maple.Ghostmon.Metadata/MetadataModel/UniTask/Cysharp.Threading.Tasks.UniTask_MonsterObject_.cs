...
namespace Maple.Ghostmon
{
    ...
    partial class UniTask_MonsterObject(Maple.MonoGameAssistant.Core.MonoCollectorContext collectorContext, Maple.MonoGameAssistant.MonoCollector.MonoCollectorClassInfo classInfo) : Maple.MonoGameAssistant.Core.MonoCollectorMember(collectorContext, classInfo)
    {
        ...
        {
            readonly delegate* unmanaged[SuppressGCTransition]<Maple.Ghostmon.UniTask_MonsterObject.Ptr_UniTask_MonsterObject, UniTaskStatus> _func = (delegate* unmanaged[SuppressGCTransition]<Maple.Ghostmon.UniTask_MonsterObject.Ptr_UniTask_MonsterObject, UniTaskStatus>)ptr;
            ...
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            public UniTaskStatus Invoke(Maple.Ghostmon.UniTask_MonsterObject.Ptr_UniTask_MonsterObject __this__) => _func(__this__);
        }
        ...
        {
            [System.Runtime.CompilerServices.MethodImplAttribute(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            public UniTaskStatus GET_STATUS() => Func_GET_STATUS.Invoke(this);
        }
