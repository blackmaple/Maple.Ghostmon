...
namespace Maple.Ghostmon.Metadata
{
    ...
    [MonoCollectorSearchFieldAttribute(typeof(AVGUserDataManager.Ptr_AVGUserDataManager), "instance", "INSTANCE", true)]

    // class 0x10 Ghostmon.AVGUserData userData
    [MonoCollectorSearchFieldAttribute(typeof(AVGUserData.Ptr_AVGUserData), "userData", "USER_DATA")]
